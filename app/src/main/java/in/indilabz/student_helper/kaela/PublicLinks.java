...
public class PublicLinks {
    public static String TEACHER_URL_REGISTER = "https://pedir.in/register_user/register_teacher.php";
    public static String STUDENT_URL_REGISTER = "https://pedir.in/register_user/register_student.php";
    public static String LOGIN_URL = "https://pedir.in/register_user/login.php";
