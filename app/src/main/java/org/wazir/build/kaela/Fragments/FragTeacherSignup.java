...
import static org.wazir.build.kaela.PublicLinks.TEACHER_URL_REGISTER;
...
public class FragTeacherSignup extends Fragment {
    ...
    private void registerUser(final String[] objects) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TEACHER_URL_REGISTER,
